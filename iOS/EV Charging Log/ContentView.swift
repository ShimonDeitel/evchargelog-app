...
struct ContentView: View {
    ...
    @State private var editingItem: ChargeSession?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("EV Charging Log")
            .toolbar {
    ...
    private func editSheet(for item: ChargeSession) -> some View {
...
struct EditItemView: View {
    ...
    @State var item: ChargeSession
    var onSave: (ChargeSession) -> Void
    var onDelete: () -> Void
